...
**4)** En cherchant la commande `ll` dans le manuel, on remarque qu'il n'existe pas d'entrée correspondante. Cela s'explique par le fait que `ll` est un alias de `ls` utilisant l'argument -alF, ou alF désignes les 3 options suivantes : 
